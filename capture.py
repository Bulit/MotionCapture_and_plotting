...
# becouse my first camera frame is black app launch camera then wait 3 sec and then save frame in while loop
time.sleep(3)
video.read()
...
while True:
    ...
    status = 0
    # rotating camera becouse of broken cam in my laptop, if your cam work ok, then delete cv2.ROTATE_180
    ...
    # Dilating white area // smoothing treshhold frame // None - Kernel Array used for dilatation // iteration to set how many times
    ...
    # if needed you can delete all except one and it will still work
